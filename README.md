# Ensina+ | Tecnologia para todas as idades

![UTFPR](https://img.shields.io/badge/UTFPR-Software%20Engineering-yellow)
![Status](https://img.shields.io/badge/Status-Em%20Desenvolvimento-green)

O **Ensina+** é uma Landing Page desenvolvida como projeto prático para a disciplina de **Desenvolvimento Front-End** do curso de **Engenharia de Software** da **UTFPR (Universidade Tecnológica Federal do Paraná)**.
...
├── style.css        # Estilização modularizada
└── script.js        # Lógica de controle do modal e navegação
